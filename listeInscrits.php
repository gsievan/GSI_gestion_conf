...
if(isset($_REQUEST['idVisite'])) {
	...
	// AFFICHER LES INFORMATIONS SUR LA VISITE SAUF SI ON A SUPPRIME TOUTES LES INSCRIPTIONS (idVisite vide dans ce cas)
	   ...
	   if (!empty($idVisite))
	   {
		   ...
		   echo "
		   <div id='corps'>
		   <h2>Liste des inscrits à la visite n°$idVisite chez $entreprise le $jour à $heureDebut </h2>
		   <table class='tabNonQuadrille'>
		   <tr><th>Nom</th><th>Prénom</th><th>Places dispos</th><th>Suppression</th></tr>";
